    ...
    return(
        <>
         ...
         <div class="container-fluid pt-5">
                        <div class="row px-xl-5 pb-3">
                            <div class="col-lg-3 col-md-6 col-sm-12 pb-1" data-aos="flip-down" data-aos-duration="1500">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-12 pb-1" data-aos="flip-down" data-aos-duration="1500">
                ...
                <div className="offers-product mb-5">
                    <img src="/assets/product-6.jpg" alt="offer" data-aos="flip-up"/>
                    <img src="/assets/iphone1.jfif" alt="offer" data-aos="flip-up"/>
                    <img src="/assets/mackbook.jfif" alt="offer" data-aos="flip-up"/>
                    <img src="/assets/specialtshirt.jpg" alt="offer" data-aos="flip-up"/>
                    <img src="/assets/tshirt.png" alt="offer" data-aos="flip-up"/>
                    <img src="/assets/tshirt1.webp" alt="offer" data-aos="flip-up"/>
                </div>
                {/* New Arrivals */}
     ...
     data-aos-easing="ease-in-sine">
                ...
                <div className="special-product">
                    <img src="/assets/cloth2.png" alt="offer" data-aos="fade-right" data-aos-offset="400" data-aos-easing="ease-in-sine"/>
                    <img src="/assets/cloths.jpg" alt="offer" data-aos="fade-left" data-aos-offset="400" data-aos-easing="ease-in-sine"/>
                    <img src="/assets/coupens2.jpg" alt="offer" data-aos="fade-right" data-aos-offset="400" data-aos-easing="ease-in-sine"/>
                    <img src="/assets/coupens3.jpg" alt="offer" data-aos="fade-left" data-aos-offset="400" data-aos-easing="ease-in-sine"/>
                </div>
        </>
    )
};
